...
public:
    ...
    void printConsole(int& timestep,const LinkedQueue<Patient*>* allPatients,const EarlyPList* earlyList,const PriQueue<Patient*>* lateList,
        const EU_WaitList* eWait,const EU_WaitList* uWait,const LinkedQueue<Patient*>* xWait,const PriQueue<Patient*>* inTreatment,const ArrayStack<Patient*>* finished,
         LinkedQueue<Resource*>* E_Devices, LinkedQueue<Resource*>* U_Devices, LinkedQueue<Resource*>* X_Rooms, LinkedQueue<Patient*>*E_InterruptPatients, LinkedQueue<Patient*>*U_InterruptPatients, const PriQueue<Resource*>* Maintenance) 
    {
        ...
        printInterrupt(E_InterruptPatients, U_InterruptPatients);
...
private:
    ...
    void printInterrupt(const LinkedQueue<Patient*>* Elist,const LinkedQueue<Patient*>* Ulist) {
        cout << "===================== E_Interrupt List ======================\n";
        cout << Elist->getCount() << " patients: ";
        Elist->print_list();
        cout << "\n";
        cout << "===================== U_Interrupt List ======================\n";
        cout << Ulist->getCount() << " patients: ";
        Ulist->print_list();
        cout << "\n";
    }

    void printMaintenance(const PriQueue<Resource*>* list)
    {
        cout << "===================== Maintenance List ======================\n";
        cout << list->getCount() << " Resources: ";
        list->print_list();
        cout << "\n";
    }
};
